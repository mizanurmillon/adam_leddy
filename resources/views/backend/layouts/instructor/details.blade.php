...
@section('content')
    <div class="page-header">
        ...
        <button class="se--block">Block Instructor</button>
    </div>
        ...
        <div class="se--instructor-course-layout">
            ...
            <div class="se--courses-layout">
                ...
                <div class="se--course-content-layout">
                    <a href="{{ route('admin.instructors.video.details') }}" class="se--card">
                        <img class="se--image--card" src="{{ asset('backend/assets/images/card1.png') }}" alt="course" />
                        <div class="se--card-font-layout">
                            <h2>
                                Free Artificial Intelligence Course
                            </h2>
                            <p>Instructor Name</p>
                            <p>12 Chapters | 132 Lessons</p>
                    ...
                    <a href="{{ route('admin.instructors.video.details') }}" class="se--card">
                        <img class="se--image--card" src="{{ asset('backend/assets/images/card2.png') }}" alt="course" />
                        <div class="se--card-font-layout">
                            <h2>
    ...
    <script>
        var options1 = {
            chart: {
                type: 'line',
                height: 300,
                background: '#202020', // Set background color to black
                toolbar: {
                    show: false
                } // Remove the toolbar
            },
