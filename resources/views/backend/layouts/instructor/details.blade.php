...
@section('content')
    <div class="page-header">
        ...
        @else
            <button class="se--unblock">Unblock Instructor</button>
        @endif
    </div>
            ...
            <div class="se--course--permission">
                ...
                <div class="form-check form-switch ">
                    <input class="form-check-input py-lg-3 py-2 px-3 px-lg-4" type="checkbox"
                        @if ($instructor->user->status == 'active') checked @endif role="switch" id="flexSwitchCheckDefault">
                </div>
            ...
            <div class="se--courses-layout">
                ...
                <div class="se--course-content-layout">
                    ...
                    <a href="{{ route('admin.instructors.video.details', $course->id) }}" class="se--card">
                        <img class="se--image--card" src="{{ asset( $course->thumbnail ?? 'backend/assets/images/card1.png') }}" alt="course" />
