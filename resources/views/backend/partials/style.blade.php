...
<link rel="stylesheet" href="{{ asset('backend/assets/css/plugins/nice-select.min.css') }}" />

<!-- custom css -->
<link rel="stylesheet" href="{{ asset('backend/assets/css/style.css') }}" />
<link rel="stylesheet" href="{{ asset('backend/assets/css/setu.css') }}" />
<link rel="stylesheet" href="{{ asset('backend/assets/css/setuResposive.css') }}" />
